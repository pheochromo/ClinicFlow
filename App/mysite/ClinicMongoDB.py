...
temp = {"object": "provider", "name":"Registration", "preReqs":["Registration"], "maxNum":1, "minNum":1, "varType":"uniform", "avg":5, "dev":2}
default1.insert_one(temp)
currentSettings.insert_one(temp)

temp = {"object": "provider", "name":"RNInterview", "preReqs":["Registration", "RNInterview"], "maxNum":1, "minNum":1, "varType":"uniform", "avg":10, "dev":10}
default1.insert_one(temp)
currentSettings.insert_one(temp)

temp = {"object": "provider", "name":"LaboratoryECG", "preReqs":["Registration", "RNInterview", "LaboratoryECG"], "maxNum":1, "minNum":1, "varType":"uniform", "avg":5, "dev":5}
default1.insert_one(temp)
currentSettings.insert_one(temp)

temp = {"object": "provider", "name":"LaboratoryBloodwork", "preReqs":["Registration", "RNInterview", "LaboratoryBloodwork"], "maxNum":1, "minNum":1, "varType":"uniform", "avg":5, "dev":5}
default1.insert_one(temp)
currentSettings.insert_one(temp)

temp = {"object": "provider", "name":"Anesthesiologist", "preReqs":["Registration", "RNInterview", "Anesthesiologist"], "maxNum":1, "minNum":1, "varType":"uniform", "avg":20, "dev":10}
default1.insert_one(temp)
currentSettings.insert_one(temp)

temp = {"object": "provider", "name":"X-Ray", "preReqs":["Registration","RNInterview","LaboratoryECG","LaboratoryBloodwork","X-Ray"], "maxNum":1, "minNum":1, "varType":"uniform", "avg":20, "dev":20}
default1.insert_one(temp)
currentSettings.insert_one(temp)
